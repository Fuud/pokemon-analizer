...
public class RequestHandler implements Runnable {
	 ...
	 */
	public RequestHandler(OkHttpClient client, CredentialProvider credentialProvider) throws LoginFailedException, RemoteServerException {
		this.client = client;
	...
	private AuthTicket internalSendServerRequests(AuthTicket authTicket, ServerRequest... serverRequests)
		...
		fuud.copied.Signature.setSignature(builder, startTime);
