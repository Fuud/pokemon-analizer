...
import com.pokegoapi.main.ApiSettings;
import com.pokegoapi.main.AsyncServerRequest;
import com.pokegoapi.main.ResultOrException;
...
public class RequestHandler implements Runnable {
    ...
    private final long seed = hash(UUID.randomUUID().toString());

    public RequestHandler(OkHttpClient client, CredentialProvider credentialProvider) {
    ...
    private AuthTicket internalSendServerRequests(AuthTicket authTicket, ServerRequest... serverRequests)
        ...
        Signature.setSignature(startTime, sessionHash, seed, builder);
    ...
    private void resetBuilder(RequestEnvelope.Builder builder, AuthTicket authTicket)
        ...
        if (authTicket != null
            ...
            builder.setAuthInfo(credentialProvider.getAuthInfo());
        }
        builder.setMsSinceLastLocationfix(989);
        builder.setLatitude(0);
        builder.setLongitude(0);
